...
public class OPMhud {
    public abstract class HudElement {
        ...
        public OPMhudType parent;

        /**
         * Constructor
         *
         * @param type     The OPMhudtype of this element
         ...
         */
        public HudElement(OPMhudType type, int posX, int posY, int width, int height, boolean moveable) {
            this.type = type;
            this.posX = posX;
            this.posY = posY;
